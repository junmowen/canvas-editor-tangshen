...
| 文件 | 职责 |
| --- | --- |
| `ImageHitTestPolicy.ts` | 图片直击、浮动图片前后景命中和候选判断 |
...
| `ImageHitTestPolicy.ts` | `isImageDirectHitElement(element)` | 判断元素是否可按图片直接命中。 | `position/PositionHitTestMethods.ts` |
