...
} from '../modules/chart-graphics/presets/ChartGraphicPreset'
import { createChartGraphicSnapshot } from '../modules/chart-graphics/runtime/ChartGraphicSnapshotPolicy'
import { validateChartGraphic } from '../modules/chart-graphics/model/ChartGraphicValidationPolicy'
import { normalizeChartGraphicDataResult } from '../modules/chart-graphics/runtime/ChartGraphicDataBindingPolicy'
import { mergeChartGraphicDataPatch } from '../modules/chart-graphics/runtime/ChartGraphicDataMergePolicy'
import { walkCommandElementList } from './CommandElementTraversal'
import {
  createChartGraphicInternalSelectionDeletePatch,
  isValidChartGraphicInternalEditingState,
  isValidChartGraphicInternalSelection
} from '../modules/chart-graphics/selection/ChartGraphicSelectionPolicy'
...
export class CommandAdaptMedia extends CommandAdaptTable {
  ...
  private isValidChartGraphicInternalEditingState(
    ...
    return isValidChartGraphicInternalEditingState(chart, state)
  }
  ...
  private isValidChartGraphicInternalSelection(
    ...
    return isValidChartGraphicInternalSelection(chart, selection)
  }
  ...
  private createChartGraphicInternalSelectionDeletePatch(
    ...
    return createChartGraphicInternalSelectionDeletePatch(chart, selection)
  }
