...
export const INTERNAL_CONTEXT_MENU_KEY = {
  ...
  CHART: {
    REFRESH_SOURCE: 'chartRefreshSource',
    CLEAR_DENTAL_STATUS: 'chartClearDentalStatus',
    EDIT_DENTAL_NOTE: 'chartEditDentalNote',
    INSERT_MARK: 'chartInsertMark',
    INSERT_ANNOTATION: 'chartInsertAnnotation',
    INSERT_POINT: 'chartInsertPoint',
    EDIT_POINT: 'chartEditPoint',
    EDIT_MARK: 'chartEditMark',
    EDIT_REGION: 'chartEditRegion',
    EDIT_ANNOTATION: 'chartEditAnnotation',
    DELETE_POINT: 'chartDeletePoint',
    DELETE_MARK: 'chartDeleteMark',
    DELETE_REGION: 'chartDeleteRegion',
    DELETE_ANNOTATION: 'chartDeleteAnnotation',
    DENTAL_STATUS: 'chartDentalStatus',
    DENTAL_STATUS_MISSING: 'chartDentalStatusMissing',
    DENTAL_STATUS_CARIES: 'chartDentalStatusCaries',
    DENTAL_STATUS_FILLED: 'chartDentalStatusFilled',
    DENTAL_STATUS_ROOT_CANAL: 'chartDentalStatusRootCanal',
    DENTAL_STATUS_CROWN: 'chartDentalStatusCrown',
    DENTAL_STATUS_IMPLANT: 'chartDentalStatusImplant'
  },
  TABLE: {
    ...
    AUTO_FIT_WIDTH: 'tableAutoFitWidth',
