...
- [table-refactor-plan.md](/D:/canvas-editor/docs/guide/table-refactor-plan.md)
- [table-pagination-input.cy.ts](/D:/canvas-editor/cypress/e2e/menus/table-pagination-input.cy.ts)
- [table-pagination-merged.cy.ts](/D:/canvas-editor/cypress/e2e/menus/table-pagination-merged.cy.ts)
...
- [TableSelectionSnapshot.ts](/D:/canvas-editor/src/editor/core/table/selection/TableSelectionSnapshot.ts)
- [TableSelectionProjectionService.ts](/D:/canvas-editor/src/editor/core/table/selection/TableSelectionProjectionService.ts)
...
- [RangeManager.ts](/D:/canvas-editor/src/editor/core/range/RangeManager.ts)
- [CommandAdapt.ts](/D:/canvas-editor/src/editor/core/command/CommandAdapt.ts)
- [RowRenderer.ts](/D:/canvas-editor/src/editor/core/draw/render/RowRenderer.ts)
- [resolveSelectionContent.ts](/D:/canvas-editor/src/editor/core/range/utils/resolveSelectionContent.ts)
...
- [TableHitTestService.ts](/D:/canvas-editor/src/editor/core/table/hittest/TableHitTestService.ts)
- [TableHitTestTypes.ts](/D:/canvas-editor/src/editor/core/table/hittest/TableHitTestTypes.ts)
...
- [Position.ts](/D:/canvas-editor/src/editor/core/position/Position.ts)
- [TableHitTestService.ts](/D:/canvas-editor/src/editor/core/table/hittest/TableHitTestService.ts)
- [resolveSelectionPointerPosition.ts](/D:/canvas-editor/src/editor/core/event/utils/resolveSelectionPointerPosition.ts)
- [TableHitTestService.ts](/D:/canvas-editor/src/editor/core/table/hittest/TableHitTestService.ts)
...
- [TableNavigationService.ts](/D:/canvas-editor/src/editor/core/table/navigation/TableNavigationService.ts)
- [TableNavigationTypes.ts](/D:/canvas-editor/src/editor/core/table/navigation/TableNavigationTypes.ts)
...
- [KeyboardNavigationIntent.ts](/D:/canvas-editor/src/editor/core/event/keyboard/intents/KeyboardNavigationIntent.ts)
- [VerticalNavigationIntent.ts](/D:/canvas-editor/src/editor/core/event/keyboard/intents/VerticalNavigationIntent.ts)
- [DeleteIntent.ts](/D:/canvas-editor/src/editor/core/event/keyboard/intents/DeleteIntent.ts)
- [BackspaceIntent.ts](/D:/canvas-editor/src/editor/core/event/keyboard/intents/BackspaceIntent.ts)
- [horizontalMove.ts](/D:/canvas-editor/src/editor/core/event/keyboard/shared/horizontalMove.ts)
...
- [TableLayoutSnapshot.ts](/D:/canvas-editor/src/editor/core/table/layout/TableLayoutSnapshot.ts)
- [TableLayoutSnapshotBuilder.ts](/D:/canvas-editor/src/editor/core/table/layout/TableLayoutSnapshotBuilder.ts)
...
- [TableFragmentFacade.ts](/D:/canvas-editor/src/editor/core/draw/paging/TableFragmentFacade.ts)
- [TableFragmentRegistryAccessor.ts](/D:/canvas-editor/src/editor/core/draw/paging/TableFragmentRegistryAccessor.ts)
- [TableFragmentRegistry.ts](/D:/canvas-editor/src/editor/core/draw/paging/TableFragmentRegistry.ts)
- [TableLayoutEngine.ts](/D:/canvas-editor/src/editor/core/draw/layout/TableLayoutEngine.ts)
- [TableFragmentSplitter.ts](/D:/canvas-editor/src/editor/core/draw/layout/TableFragmentSplitter.ts)
...
- [TableOverlayRenderer.ts](/D:/canvas-editor/src/editor/core/table/render/TableOverlayRenderer.ts)
- [RenderInvalidationManager.ts](/D:/canvas-editor/src/editor/core/table/render/RenderInvalidationManager.ts)
...
- [Draw.ts](/D:/canvas-editor/src/editor/core/draw/Draw.ts)
- [PageRenderer.ts](/D:/canvas-editor/src/editor/core/draw/render/PageRenderer.ts)
- [RowRenderer.ts](/D:/canvas-editor/src/editor/core/draw/render/RowRenderer.ts)
- [RenderInvalidationManager.ts](/D:/canvas-editor/src/editor/core/table/render/RenderInvalidationManager.ts)
- [mousemove.ts](/D:/canvas-editor/src/editor/core/event/handlers/mousemove.ts)
- [mouseup.ts](/D:/canvas-editor/src/editor/core/event/handlers/mouseup.ts)
...
- [RowRenderer.ts](/D:/canvas-editor/src/editor/core/draw/render/RowRenderer.ts)
- [Position.ts](/D:/canvas-editor/src/editor/core/position/Position.ts)
- [resolveSelectionStartState.ts](/D:/canvas-editor/src/editor/core/event/utils/resolveSelectionStartState.ts)
- [resolveSelectionPointerPosition.ts](/D:/canvas-editor/src/editor/core/event/utils/resolveSelectionPointerPosition.ts)
