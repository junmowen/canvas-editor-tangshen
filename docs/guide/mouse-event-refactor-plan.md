...
- [CanvasEvent.ts](/D:/canvas-editor/src/editor/core/event/CanvasEvent.ts)
...
- [mousedown.ts](/D:/canvas-editor/src/editor/core/event/handlers/mousedown.ts)
...
- [click.ts](/D:/canvas-editor/src/editor/core/event/handlers/click.ts)
- [drag.ts](/D:/canvas-editor/src/editor/core/event/handlers/drag.ts)
...
- [MouseObserver.ts](/D:/canvas-editor/src/editor/core/observer/MouseObserver.ts)
- [CanvasEvent.ts](/D:/canvas-editor/src/editor/core/event/CanvasEvent.ts)
...
- [DrawViewportService.ts](/D:/canvas-editor/src/editor/core/draw/viewport/DrawViewportService.ts)
  - 同时兼容 `clientX/clientY` 和 `offsetX/offsetY`
- [Previewer.ts](/D:/canvas-editor/src/editor/core/draw/particle/previewer/Previewer.ts)
  - 使用 `evt.x / evt.y`
- [TableTool.ts](/D:/canvas-editor/src/editor/core/draw/particle/table/TableTool.ts)
  - 使用 `evt.x / evt.y`
...
这部分基本就是把当前 [mouseup.ts](/D:/canvas-editor/src/editor/core/event/handlers/mouseup.ts) 的拖放主链整体收口成单职责模块。
