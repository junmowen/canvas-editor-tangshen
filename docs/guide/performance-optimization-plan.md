...
- [src/editor/core/table/render/RenderInvalidationManager.ts](/D:/canvas-editor/src/editor/core/table/render/RenderInvalidationManager.ts)
- [src/editor/core/draw/render/DrawRenderFacadeService.ts](/D:/canvas-editor/src/editor/core/draw/render/DrawRenderFacadeService.ts)
- [src/editor/core/draw/viewport/DrawViewportService.ts](/D:/canvas-editor/src/editor/core/draw/viewport/DrawViewportService.ts)
- [src/editor/core/table/hittest/TableHitTestService.ts](/D:/canvas-editor/src/editor/core/table/hittest/TableHitTestService.ts)
...
- [src/editor/core/draw/render/RowRenderer.ts](/D:/canvas-editor/src/editor/core/draw/render/RowRenderer.ts)
- [src/editor/core/position/Position.ts](/D:/canvas-editor/src/editor/core/position/Position.ts)
- [src/editor/core/table/hittest/TableHitTestService.ts](/D:/canvas-editor/src/editor/core/table/hittest/TableHitTestService.ts)
- [src/editor/core/draw/interactive/Search.ts](/D:/canvas-editor/src/editor/core/draw/interactive/Search.ts)
- [src/editor/core/event/handlers/mousemove.ts](/D:/canvas-editor/src/editor/core/event/handlers/mousemove.ts)
- [src/editor/core/draw/render/PageRenderer.ts](/D:/canvas-editor/src/editor/core/draw/render/PageRenderer.ts)
- [src/editor/core/command/CommandAdapt.ts](/D:/canvas-editor/src/editor/core/command/CommandAdapt.ts)
...
- [src/editor/core/draw/render/PageRenderer.ts](/D:/canvas-editor/src/editor/core/draw/render/PageRenderer.ts)
- [src/editor/core/draw/render/RowRenderer.ts](/D:/canvas-editor/src/editor/core/draw/render/RowRenderer.ts)
- [src/editor/core/table/render/TableOverlayRenderer.ts](/D:/canvas-editor/src/editor/core/table/render/TableOverlayRenderer.ts)
...
- [src/editor/core/draw/interactive/Search.ts](/D:/canvas-editor/src/editor/core/draw/interactive/Search.ts)
- [src/editor/core/worker/WorkerManager.ts](/D:/canvas-editor/src/editor/core/worker/WorkerManager.ts)
...
- [src/editor/core/draw/layout/DrawLayoutPipeline.ts](/D:/canvas-editor/src/editor/core/draw/layout/DrawLayoutPipeline.ts)
- [src/editor/core/draw/layout/PagePartitioner.ts](/D:/canvas-editor/src/editor/core/draw/layout/PagePartitioner.ts)
- [src/editor/core/table/layout/TableLayoutSnapshotBuilder.ts](/D:/canvas-editor/src/editor/core/table/layout/TableLayoutSnapshotBuilder.ts)
