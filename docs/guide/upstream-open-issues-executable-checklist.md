...
| --- | --- | --- | --- | --- | --- |
| #1404 colgroup 默认平分 | `需人工验证` | `新增最小场景验证` | [TableOperate.ts](/D:/canvas-editor/src/editor/core/draw/particle/table/TableOperate.ts), [table.cy.ts](/D:/canvas-editor/cypress/e2e/menus/table.cy.ts) | 有 table 相关测试，但未见该场景专测 | 验证后补专项测试 |
| #1399 CONTROL 选中后 backspace 无效 | `需人工验证` | `新增最小场景验证` | [BackspaceIntent.ts](/D:/canvas-editor/src/editor/core/event/keyboard/intents/BackspaceIntent.ts), [Control.ts](/D:/canvas-editor/src/editor/core/draw/control/Control.ts) | 有 checkbox/date/text 控件测试，无该删除场景专测 | 验证后补专项测试 |
| #1385 文本/列举控件下划线异常 | `需人工验证` | `新增最小场景验证` | [RowRenderer.ts](/D:/canvas-editor/src/editor/core/draw/render/RowRenderer.ts), [Underline.ts](/D:/canvas-editor/src/editor/core/draw/richtext/Underline.ts), [format.cy.ts](/D:/canvas-editor/cypress/e2e/menus/format.cy.ts) | 有 format 测试 | 验证后补专项测试 |
...
| #813 光标位置 | `部分解决` | `现有测试回归` + `新增最小场景验证` | [Cursor.ts](/D:/canvas-editor/src/editor/core/cursor/Cursor.ts), [Position.ts](/D:/canvas-editor/src/editor/core/position/Position.ts), [pointer-debug-selection.cy.ts](/D:/canvas-editor/cypress/e2e/menus/pointer-debug-selection.cy.ts) | 有 selection / pointer debug 测试 | 验证后补专项测试 |
...
| #440 列表内容内无法取消或增加子列表 | `需人工验证` | `新增最小场景验证` | [ListParticle.ts](/D:/canvas-editor/src/editor/core/draw/particle/ListParticle.ts), [text.cy.ts](/D:/canvas-editor/cypress/e2e/menus/text.cy.ts), [row.cy.ts](/D:/canvas-editor/cypress/e2e/menus/row.cy.ts) | 有文本/段落测试，无子列表专测 | 验证后补专项测试 |
| #425 文本控件内容中再插入控件显示问题 | `需人工验证` | `新增最小场景验证` | [Control.ts](/D:/canvas-editor/src/editor/core/draw/control/Control.ts), [TextControl.ts](/D:/canvas-editor/src/editor/core/draw/control/text/TextControl.ts), [text.cy.ts](/D:/canvas-editor/cypress/e2e/control/text.cy.ts) | 有 control/text 测试 | 验证后补专项测试 |
| #41 表格分页 | `部分解决` | `现有测试回归` | [table-refactor-plan.md](/D:/canvas-editor/docs/guide/table-refactor-plan.md), [table-pagination-mock.cy.ts](/D:/canvas-editor/cypress/e2e/menus/table-pagination-mock.cy.ts), [table-pagination-merged.cy.ts](/D:/canvas-editor/cypress/e2e/menus/table-pagination-merged.cy.ts) | 表格分页专项测试很多 | 持续回归，不立即作为新开发任务 |
