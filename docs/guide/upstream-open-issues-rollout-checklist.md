...
| #41 | 表格分页 | `部分解决` | 本地已有大规模分页表格重构、文档、测试与 README 主线说明；本轮将 [table-pagination-input.cy.ts](/D:/canvas-editor/cypress/e2e/menus/table-pagination-input.cy.ts) 从 28/34 推进到 34/34，将 [table-pagination-mock.cy.ts](/D:/canvas-editor/cypress/e2e/menus/table-pagination-mock.cy.ts) 收敛到 13/13，并将 [table-pagination-multicell.cy.ts](/D:/canvas-editor/cypress/e2e/menus/table-pagination-multicell.cy.ts) 收敛到 4/4；[table-pagination-merged.cy.ts](/D:/canvas-editor/cypress/e2e/menus/table-pagination-merged.cy.ts) 仍稳定 0/5，主要失败是合并单元格找不到 later fragment 点，详见 [issue-41-table-pagination-failure-breakdown.md](/D:/canvas-editor/docs/guide/issue-41-table-pagination-failure-breakdown.md)。 | 下一步集中修合并单元格分页布局/命中，再做人工样例确认。 |
